...
| M4 - Assignment 1 and 3 validation evidence | In Progress | A1 runners support LinuxBridge fallback on WSL; A3 uses one-command WSL runner; final evidence/report pending |
